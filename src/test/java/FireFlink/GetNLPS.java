...
public class GetNLPS {
    public static String NLPs() throws InterruptedException {
...
//	System.out.println(token);
        ...
        header.put("platform", "Web & Mobile");
        header.put("projectId", "PJT1002");
        header.put("projectType", "Web & Mobile");
...
//	for(int i=0;i<no;i++) {
//		String platFormName=js.get("responseObject[" + i + "].platform");
